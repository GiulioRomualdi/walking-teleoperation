...
private:
	...
	std::unique_ptr<FingersRetargeting> m_leftHandFingers; /**< Pointer to the left finger retargeting object. */
	std::unique_ptr<FingersRetargeting> m_rightHandFingers; /**< Pointer to the right finger retargeting object. */
	std::unique_ptr<HandRetargeting> m_rightHand; /**< Pointer to the right hand retargeting object. */
	std::unique_ptr<HandRetargeting> m_leftHand; /**< Pointer to the left hand retargeting object. */
	...
	yarp::os::BufferedPort<yarp::os::Bottle> m_oculusOrientationPort; /**< Oculus orientation port. */
	yarp::os::BufferedPort<yarp::sig::Vector> m_playerOrientationPort; /**< Player orientation port. */
	yarp::os::BufferedPort<yarp::os::Bottle> m_imagesOrientationPort;
	yarp::os::BufferedPort<yarp::sig::Vector> m_robotOrientationPort;
	yarp::os::BufferedPort<yarp::sig::Vector> m_joypadAxisPort; /**< Port for axis data of oculus joypad for decoupling */
